...
const TEST_XLSX_FILE_NAME = testUtils.makeTempFileName('wb.test');
const TEST_CSV_FILE_NAME = testUtils.makeTempFileName('wb.test', 'csv');
    ...
    describe('Duplicate Rows', () => {
      it('Duplicate rows with styles properly', () => {
        const fileDuplicateRowTestFile =
          './tests/integration/data/duplicateRowTest.xlsx';
        const wb = new ExcelJS.Workbook();
